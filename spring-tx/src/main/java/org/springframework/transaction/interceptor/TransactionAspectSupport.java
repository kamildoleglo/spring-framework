...
public abstract class TransactionAspectSupport implements BeanFactoryAware, InitializingBean {
	...
	protected Object invokeWithinTransaction(Method method, @Nullable Class<?> targetClass,
		...
		if (this.reactiveAdapterRegistry != null && tm instanceof ReactiveTransactionManager) {
			...
			Publisher<?> returnValue = (Publisher<?>) txSupport.invokeWithinTransaction(method, targetClass, invocation, txAttr, (ReactiveTransactionManager) tm);
			return (isSuspendingFunction ? (hasSuspendingFlowReturnType ? KotlinDelegate.asFlow(returnValue) : KotlinDelegate.awaitSingleOrNull(returnValue, ((CoroutinesInvocationCallback)invocation).getContinuation())) : returnValue);
		}
	...
	interface CoroutinesInvocationCallback extends InvocationCallback {
